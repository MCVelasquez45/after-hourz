...
export default defineConfig({
  ...
  // One local retry absorbs transient flake in full-page photographic visual snapshots
  // (large images + web fonts across engines); strict specs still fail hard on real bugs.
